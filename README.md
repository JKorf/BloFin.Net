...
[![Docs](https://img.shields.io/badge/Docs-BloFin.Net-1b7f50?style=for-the-badge)](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=BloFin.Net)
...
The [BloFin.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=BloFin.Net) is the main resource for installing, configuring, and using the library.

| Resource | Description |
|--|--|
| [Client guide](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=BloFin.Net) | Installation, REST and WebSocket clients, authentication, dependency injection, error handling, and advanced features |
| [Examples](https://cryptoexchange.jkorf.dev/docs/exchange-clients/examples?library=BloFin.Net) | Common REST and WebSocket operations |
| [API reference](https://cryptoexchange.jkorf.dev/docs/exchange-clients/reference?library=BloFin.Net) | Client interfaces, methods, and properties |
...
### NuGet 
[![NuGet version](https://img.shields.io/nuget/v/BloFin.net.svg?style=for-the-badge)](https://www.nuget.org/packages/BloFin.Net)  [![Nuget downloads](https://img.shields.io/nuget/dt/BloFin.Net.svg?style=for-the-badge)](https://www.nuget.org/packages/BloFin.Net)

	dotnet add package BloFin.Net
	
### GitHub packages
BloFin.Net is available on [GitHub packages](https://github.com/JKorf/BloFin.Net/pkgs/nuget/BloFin.Net). You'll need to add `https://nuget.pkg.github.com/JKorf/index.json` as a NuGet package source.

### Download release
[![GitHub Release](https://img.shields.io/github/v/release/JKorf/BloFin.Net?style=for-the-badge&label=GitHub)](https://github.com/JKorf/BloFin.Net/releases)
...
For more examples and explanations, continue with the [BloFin.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=BloFin.Net) or browse the [compilable repository examples](https://github.com/JKorf/BloFin.Net/tree/main/Examples).
...
* Version 3.3.0 - 29 Jul 2026
    ...
    * Added OfflineTime, AssetClass to BloFinSymbol model, updated Shared GetFuturesSymbolsAsync asset classification logic
...
* Version 3.1.0 - 09 Jul 2026
    ...
    * Added ThresholdX/Y/Z properties to BloFinSymbol model
