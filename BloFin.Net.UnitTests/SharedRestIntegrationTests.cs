...
namespace BloFin.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IBloFinRestClientAccountApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddBloFin(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IBloFinRestClient>().AccountApi.SharedClient;
        }

        private IBloFinRestClientFuturesApiShared GetFuturesRestClient()
        {
            ExchangeParameters.SetStaticParameter("BloFin", "SettleAsset", "usdt");
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IBloFinRestClient>().FuturesApi.SharedClient;
        }
