...
namespace BloFin.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IBloFinUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, BloFinCredentials credentials, BloFinEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBloFinRestClient GetRestClient(string userIdentifier, BloFinCredentials? credentials = null, BloFinEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBloFinSocketClient GetSocketClient(string userIdentifier, BloFinCredentials? credentials = null, BloFinEnvironment? environment = null);
    }
}