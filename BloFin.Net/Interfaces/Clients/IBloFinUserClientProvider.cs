...
namespace BloFin.Net.Interfaces.Clients
{
    ...
    public interface IBloFinUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, BloFinEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBloFinRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, BloFinEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBloFinSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, BloFinEnvironment? environment = null);
    }
}